        ...
        <div className="aboutUs__content">
            <p className="aboutUs__companyOverview">
                <mark className='bg-accent'>
                    "রিফ্লেকশন ডিজাইন এন্ড আর্কিটেক্ট" বাংলাদেশের অন্যতম প্রপার্টি ডেভেলপমেন্ট কোম্পানি। ১০টির বেশি উন্নতমানের সেবা নিয়ে তারা বর্তমানে দক্ষিণ চট্টগ্রামে সরাসরি, এবং সারা বাংলাদেশে অনলাইনের মাধ্যমে কার্যক্রম চালিয়ে যাচ্ছে।
                </mark>
            </p>
